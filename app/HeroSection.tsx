...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-[70vh] flex items-start justify-center overflow-hidden pt-24 sm:pt-32"
      style={{
    ...
    >
      ...
      >
        <source src="/prepare_soup_sample.mp4" type="video/mp4" />
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 pb-12 text-center flex flex-col items-center">
        {/* Strong backdrop behind text content for readability */}
        <div 
          className="absolute inset-0 rounded-3xl pointer-events-none"
          style={{
            background: 'radial-gradient(ellipse 900px 700px at center, rgba(254, 251, 248, 0.85) 0%, rgba(254, 251, 248, 0.65) 50%, rgba(254, 251, 248, 0.3) 80%, transparent 100%)',
            zIndex: -1,
        ...
        >
          ...
          <AnimatedContent distance={30} duration={0.9} delay={0.35}>
            <p 
              ...
              style={{ 
                textShadow: '0 2px 8px rgba(253, 246, 237, 0.9), 0 3px 12px rgba(253, 246, 237, 0.6), 0 1px 4px rgba(90, 68, 56, 0.25)',
